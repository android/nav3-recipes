...
class ParseIntentActivity : ComponentActivity() {
    ...
    private val deepLinkCandidates: List<DeepLinkCandidate<out NavRecipeKey>> = listOf(
        // "https://www.nav3recipes.com/home"
        DeepLinkCandidate(HomeKey.serializer(), (URL_HOME_EXACT).toUri()),
        // "https://www.nav3recipes.com/users/with/{filter}"
        DeepLinkCandidate(UsersKey.serializer(), (URL_USERS_WITH_FILTER).toUri()),
        // "https://www.nav3recipes.com/users/search?{firstName}&{age}&{location}"
        DeepLinkCandidate(SearchKey.serializer(), (URL_SEARCH.toUri())),
    )
